<?php
    ...
    if(empty($errors)){     
        ...
        $message  = "Имя пользователя: " . $_POST['form_name'] . "<br/><br/>";
        $message .= "Тема сообщения: " . $_POST['form_email'] . "<br/><br/>";
        $message .= "Текст письма: " . $_POST['form_message'];      
        send_mail($message); // отправим письмо
        // выведем сообщение об успехе
        $msg_box = "<span style='color: green;font-size: 1.4em;'>Спасибо за обращение, сообщение успешно отправлено! <br/> В течении 24 часов Мы вам ответим!<br/></span><br/>";
    ...
    function send_mail($message){
        ...
        $mail_to = "obratnaya_svyaz_scazochnik@mail.ru";
        // тема письма
        $subject = "Создатель, тебе опять холопы пишут";
